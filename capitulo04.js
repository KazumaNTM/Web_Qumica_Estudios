/* ============================================================================
   CAPÍTULO 4 — Matemáticas técnicas (Física, Cap. 2 del libro de Tippens)
   Este archivo SOLO contiene contenido (texto, preguntas, respuestas), igual
   que capitulo01.js, 02.js y 03.js. No hay aquí ni una línea de diseño ni de
   lógica: todo eso vive en motor.js (el motor). Si necesitas corregir un dato
   de matemáticas, este es el único archivo que hay que tocar; si necesitas
   cambiar cómo se ve la página, nunca es aquí.
   NOTA: en el libro de Tippens este es el "Capítulo 2", pero aquí usamos
   numero: 4 porque los números 1, 2 y 3 ya los ocupan los capítulos de
   química. El "numero" que usa la app es un orden interno del menú, no
   tiene que coincidir con el número del capítulo dentro de su libro
   original (por eso el título sigue diciendo "Matemáticas técnicas" y no
   "Capítulo 4", para no generar confusión con el libro fuente).
   Fuente: Tippens, Paul E. — Física, Conceptos y Aplicaciones, Capítulo 2
   "Matemáticas técnicas" (págs. 6-33 del PDF proporcionado).
   ============================================================================ */
registrarCapitulo({
    materia: 'fisica', // NUEVO: agrupa este capítulo bajo "Física" en el menú (independiente de química)
    // Como "numero" ahora solo debe ser único DENTRO de "fisica", puede volver
    // a ser el número real del libro de Tippens (Cap. 2) sin chocar con nada.
    numero: 2,
